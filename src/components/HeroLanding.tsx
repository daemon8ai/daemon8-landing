          ...
          <div className="da-hero">
            <div className="da-hero__content">
              ...
              <p className="da-hero__subhead">
                Daemon8 is a local observation layer that bridges the gap across agent conversations, scattered log output, and live debug behavior. It auto-discovers project environments to funnel logs, browser consoles, network traffic, and device events into a single, unified stream. By converging this context and surfacing it over MCP, your agent gets a 360-degree view of everything happening through a single tool—one that can be instantly filtered, checkpointed, and recalled across sessions. One binary. Everything stays local.
              </p>
